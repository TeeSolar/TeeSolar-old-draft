...
public:
	...
	public:
		...
		{	
			...
			pLayout->Add(new gui::CLabelHeader(Context(), _LSTRING("TeeSolar")), false);
			
			{
				...
				pList->Add(new gui::CLabel(Context(), "0.4.0"), true); //TAG_ASSETSVERSION
			}
			{
				gui::CHListLayout* pList = new gui::CHListLayout(Context());
				pLayout->Add(pList, true);
				pList->Add(new gui::CLabel(Context(), _LSTRING("Copyright ©:")), true);
				pList->Add(new gui::CLabel(Context(), "2023 RemakePower"), true);
			}
